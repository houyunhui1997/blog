...
`ReturnType<Type>` [#](about:blank#returntypetype)
--------------------------------------------------
...
`ThisParameterType<Type>` [#](about:blank#thisparametertypetype)
----------------------------------------------------------------
...
### `Capitalize<StringType>` [#](about:blank#capitalizestringtype)
